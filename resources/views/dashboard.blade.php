...
@section('title')
<title>Dashboard - Customer Relation Managment System</title>
@endsection
        ...
        <div class="card bd-primary mg-t-20">
          ...
          <div class="card-body">
            <div class="media-list">
              <div class="media">
                <img src="{{ asset('public/img/img9.jpg') }}" class="wd-50 rounded-circle" alt="">
              ...
              <div class="media">
                <img src="{{ asset('public/img/img5.jpg') }}" class="wd-50 rounded-circle" alt="">
                <div class="media-body mg-l-20">
              ...
              <div class="media">
                <img src="{{ asset('public/img/img7.jpg') }}" class="wd-50 rounded-circle" alt="">
                <div class="media-body mg-l-20">
