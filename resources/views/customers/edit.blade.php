				...
				<div class="row mg-b-25">
					...
					<div class="col-lg-12">
						<div class="form-group mg-b-10-force">
							...
							<textarea name="address" class="form-control" placeholder="Customer Address">{{ $customer->address }}</textarea>
						</div>
					</div><!-- col-12 -->

				</div><!-- row -->	          
				<div class="form-layout-footer">
					<button class="btn btn-primary mg-r-5" type="submit">Update Customer</button>
